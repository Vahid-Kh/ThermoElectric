...
def plot_3_maxed(time, var1, var2, var3, label, week):
    ...
    host.set_ylim(min(var1), max(var1)*1.02)
    par1.set_ylim(min(var2), max(var2)*1.02)
    par2.set_ylim(min(var3), max(var3)*1.02)
